...
var Service = (function(){
    ...
    var _uploadFile = function(dataObj) {
            ...
            try{
                ...
                Model.makeAjaxFormRequest({
                    'url' : Constants.API_URL+'file/upload',
                    'type' : 'POST',
                    'data' : dataObj,
        ...
        var _getAllApplications = function(dataObj) {
            ...
            try{
                ...
                if(dataObj){
                    if(dataObj.limit)
                        queryString = "?limit="+dataObj.limit;
                    if(dataObj.cursor)
                        queryString = "&"+dataObj.cursor;
                }

                Model.makeAjaxRequest({
                    'url' : Constants.API_URL+"application/get"+queryString,
                    'type' : 'GET',
                    'contentType' 	: "application/json"
                }).done(function(data) {
                    if(data) {
        ...
        var _createApplication = function(dataObj) {
            ...
            try{
                Model.makeAjaxRequest({
                    'url' : Constants.API_URL+"application/create",
                    'type' : 'POST',
                    'data' : JSON.stringify(dataObj),
                    'contentType' 	: "application/json"
                }).done(function(data) {
